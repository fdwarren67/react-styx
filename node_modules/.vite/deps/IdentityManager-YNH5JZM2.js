...
var m3 = class extends O {
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-O4D737DM.js"), dialog: () => import("./calcite-dialog-BVFB2D47.js"), input: () => import("./calcite-input-GU5Y2KXZ.js"), label: () => import("./calcite-label-OKNCET7S.js"), notice: () => import("./calcite-notice-ZJGBVXUG.js") });
  }
  get title() {
    var _a;
...
r([m2({ json: { write: true } })], i4.prototype, "adminTokenServiceUrl", void 0), r([m2({ json: { write: true } })], i4.prototype, "currentVersion", void 0), r([m2({ json: { write: true } })], i4.prototype, "hasPortal", void 0), r([m2({ json: { write: true } })], i4.prototype, "hasServer", void 0), r([m2({ json: { write: true } })], i4.prototype, "owningSystemUrl", void 0), r([m2({ json: { write: true } })], i4.prototype, "owningTenant", void 0), r([m2({ json: { write: true } })], i4.prototype, "server", void 0), r([m2({ json: { write: true } })], i4.prototype, "shortLivedTokenValidity", void 0), r([m2({ json: { write: true } })], i4.prototype, "tokenServiceUrl", void 0), r([m2({ json: { write: true } })], i4.prototype, "webTierAuth", void 0), i4 = r([a("esri.identity.ServerInfo")], i4);
var s6 = i4;
...
var j = class extends i2 {
  ...
  oAuthSignIn(e3, t3, r4, s8) {
    ...
    let n2;
    (s8 == null ? void 0 : s8.signal) && m(s8.signal, () => {
...
var E = class extends i2.EventedAccessor {
  ...
  refreshToken() {
    const e3 = s3, t3 = e3.findServerInfo(this.server), s8 = t3 == null ? void 0 : t3.owningSystemUrl, i5 = !!s8 && "server" === this.scope, o2 = i5 && D(t3, e3._legacyFed), n2 = t3.webTierAuth, a3 = n2 && e3.normalizeWebTierAuth, h2 = R[this.server], l2 = h2 == null ? void 0 : h2[this.userId];
  ...
  emitTokenChange(e3) {
    ...
    const t3 = s3, s8 = this.server ? t3.findServerInfo(this.server) : null, i5 = s8 == null ? void 0 : s8.owningSystemUrl, o2 = i5 ? t3.findServerInfo(i5) : null;
...
//# sourceMappingURL=IdentityManager-YNH5JZM2.js.map
