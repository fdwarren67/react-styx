...
import {
  I as I2,
  p as p3
} from "./chunk-3TR2ZGBG.js";
import {
  e
} from "./chunk-XIL65DCI.js";
import {
  o as o3
...
r([m({ type: w, json: { read: { source: "fullExtent" } } })], n.prototype, "fullExtent", void 0), r([m({ type: String, json: { read: { source: "id" } } })], n.prototype, "id", void 0), r([m({ type: z, json: { read: { source: "tileInfo" } } })], n.prototype, "tileInfo", void 0), n = l = r([a3("esri.layers.support.TileMatrixSet")], n);
var p4 = n;
...
function v3(e2, t3) {
  const i2 = I3(t3), [n2, l2] = w2("TopLeftCorner", e2).split(" ").map((e3) => parseFloat(e3)), s2 = t3.includes("epsg") && o4(i2.wkid);
...
//# sourceMappingURL=WMTSLayer-O73UKE2U.js.map
