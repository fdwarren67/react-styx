...
var c = class extends g {
  ...
  async update(t, r2) {
    const { addOrUpdateResources: e2 } = await import("./resourceUtils-5TO7L7TV.js");
...
var k = v = class extends S.JSONSupportMixin(m2) {
  ...
  async fetchResources(e2 = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-5TO7L7TV.js");
    return i(this, e2, t);
  }
  async addResource(e2, t, i) {
    const { addOrUpdateResources: r2 } = await import("./resourceUtils-5TO7L7TV.js");
  ...
  async removeResource(e2, t) {
    const { removeResource: r2 } = await import("./resourceUtils-5TO7L7TV.js");
  ...
  async removeAllResources(e2) {
    const { removeAllResources: t } = await import("./resourceUtils-5TO7L7TV.js");
    return t(this, e2);
  }
  resourceFromPath(e2) {
...
//# sourceMappingURL=chunk-4GYBOMKF.js.map
