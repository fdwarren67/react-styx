...
function _() {
  return t || (t = import("./pe-wasm-W5D6GJKS.js").then((e) => e.p).then(({ default: t2 }) => t2({ locateFile: (t3) => n(`esri/geometry/support/${t3}`) })).then((e) => {
    d(e);
  }), t);
}
var P;
...
//# sourceMappingURL=chunk-6K2FAOQG.js.map
