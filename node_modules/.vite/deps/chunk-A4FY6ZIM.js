...
async function r2(l, e, o2) {
  ...
  return (await Promise.all(a2.map(async (o3, n2) => ({ value: o3, color: "opacity" === l.type ? await t(o3, l, e) : (await import("./visualVariableUtils-DBBT3UHC.js")).getColor(l, o3), label: r3 ? u2[n2] : (c == null ? void 0 : c[n2]) ?? "" })))).reverse();
}
async function t(e, n2, r3) {
  const t2 = new h(r3 ?? o), a2 = (await import("./visualVariableUtils-DBBT3UHC.js")).getOpacity(n2, e);
...
//# sourceMappingURL=chunk-A4FY6ZIM.js.map
