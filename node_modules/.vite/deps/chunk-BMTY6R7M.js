...
function I(a) {
  ...
  a.sortable = sortable_esm_default.create(a.el, {
    dataIdAttr: c,
    ...u,
    ...!!b && { draggable: b },
    ...!!n && {
    ...
    onStart: ({ from: r, item: e, to: l, newDraggableIndex: t, oldDraggableIndex: o }) => {
      g.active = true, S(), a.onDragStart({ fromEl: r, dragEl: e, toEl: l, newIndex: t, oldIndex: o });
    },
    onEnd: ({ from: r, item: e, to: l, newDraggableIndex: t, oldDraggableIndex: o }) => {
      g.active = false, x(), a.onDragEnd({ fromEl: r, dragEl: e, toEl: l, newIndex: t, oldIndex: o });
    },
...
function D(a) {
  var _a;
  i(a) || (d.delete(a), (_a = a.sortable) == null ? void 0 : _a.destroy(), a.sortable = null);
}
var g = { active: false };
function i(a) {
...
@esri/calcite-components/dist/chunks/sortableComponent.js:
  ...
  v3.1.0 *)
*/
//# sourceMappingURL=chunk-BMTY6R7M.js.map
