...
function F(t, n) {
  const { separator: e, unitOrder: r } = n, a = S(r), o = t.split(e).map((u) => q.delocalize(u)), s = o[a.indexOf("d")], i = o[a.indexOf("m")], c = o[a.indexOf("y")];
...
@esri/calcite-components/dist/chunks/date.js:
  ...
  v3.1.0 *)
*/
//# sourceMappingURL=chunk-BYGGXTK7.js.map
