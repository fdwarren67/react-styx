  ...
  (function(Ye, ie) {
    ...
    function bn(t, e) {
      for (var n = 0; n < e.length; n++) {
        var r = e[n];
        r.enumerable = r.enumerable || false, r.configurable = true, "value" in r && (r.writable = true), Object.defineProperty(t, ht(r.key), r);
      }
    }
    function D(t, e, n) {
    ...
    function xn(t, e, n) {
      return (e = ht(e)) in t ? Object.defineProperty(t, e, { value: n, enumerable: true, configurable: true, writable: true }) : t[e] = n, t;
    }
    function oe(t, e) {
    ...
    function Ft(t, e) {
      for (var n = 0, r = t.slice(); n < r.length; n++) {
        ...
        e.dropzone = o, e.target = a, o.fire(e), e.propagationStopped = e.immediatePropagationStopped = false;
      }
    }
    function Je(t, e) {
    ...
    var L, Q, q = { id: "actions/resize", before: ["actions/drag"], install: function(t) {
      ...
      E.isScrolling = true, W.cancel(E.i), t.autoScroll = E, E.interaction = t, E.prevTime = E.now(), E.i = W.request(E.scroll);
    }, stop: function() {
      E.isScrolling = false, E.interaction && (E.interaction.autoScroll = null), W.cancel(E.i);
    }, scroll: function() {
    ...
    function de(t, e) {
      var n = false;
      return function() {
        return n || (K.console.warn(e), n = true), t.apply(this, arguments);
      };
    }
    function nt(t, e) {
    ...
    var at = function() {
      ...
      return D(t, [{ key: "start", value: function(e, n) {
        ...
        var c = this.fillArg({ phase: o, pageCoords: n, preEnd: false });
        ...
        if (this.result = a, !a.changed && (!o || o < this.states.length) && n.interacting()) return false;
        if (e.modifiedCoords) {
        ...
        if (i && i.length) {
          for (var o = false, a = 0; a < i.length; a++) {
            ...
            if (l) return this.endResult = l, false;
            o = o || !o && this.shouldDo(c, true, e.phase, true);
          }
          o && n.move({ event: r, preEnd: true });
        }
    ...
    var Bn = D(function t(e, n, r, i, o) {
      ...
      function t(e) {
        ...
        k(this, t), this.interactable = null, this.element = null, this.rect = null, this._rects = void 0, this.edges = null, this._scopeFire = void 0, this.prepared = { name: null, axis: null, edges: null }, this.pointerType = void 0, this.pointers = [], this.downEvent = null, this.downPointer = {}, this._latestPointer = { pointer: null, event: null, eventTarget: null }, this.prevEvent = null, this.pointerIsDown = false, this.pointerWasMoved = false, this._interacting = false, this._ending = false, this._stopped = true, this._proxy = void 0, this.simulation = null, this.doMove = de(function(l) {
          this.move(l);
      ...
      return D(t, [{ key: "pointerMoveTolerance", get: function() {
        ...
        var i = this.updatePointer(e, n, r, true), o = this.pointers[i];
        ...
        o === -1 && (o = this.updatePointer(e, n, r, false));
        ...
        return i = i !== false && (i || /(down|start)$/i.test(n.type)), l ? l.pointer = e : (l = new Bn(c, e, n, null, null), u = this.pointers.length, this.pointers.push(l)), En(this.coords.cur, this.pointers.map(function(p) {
          return p.pointer;
        }), this._now()), o = this.coords.delta, a = this.coords.prev, s = this.coords.cur, o.page.x = s.page.x - a.page.x, o.page.y = s.page.y - a.page.y, o.client.x = s.client.x - a.client.x, o.client.y = s.client.y - a.client.y, o.timeStamp = s.timeStamp - a.timeStamp, i && (this.pointerIsDown = true, l.downTime = this.coords.cur.timeStamp, l.downTarget = r, _e(this.downPointer, e), this.interacting() || (Pe(this.coords.start, this.coords.cur), Pe(this.coords.prev, this.coords.cur), this.downEvent = n, this.pointerWasMoved = false)), this._updateLatestPointer(e, n, r), this._scopeFire("interactions:update-pointer", { pointer: e, event: n, eventTarget: r, down: i, pointerInfo: l, pointerIndex: u, interaction: this }), u;
    ...
    var Un = { id: "offset", before: ["modifiers", "pointer-events", "actions", "inertia"], install: function(t) {
      ...
      return D(t, [{ key: "start", value: function(e) {
        ...
        o.offsetBy({ x: -this.currentOffset.x, y: -this.currentOffset.y }), o.updatePointer(n, r, i, true), o._doPhase({ interaction: o, event: r, phase: "resume" }), Pe(o.coords.prev, o.coords.cur), this.stop();
      } }, { key: "end", value: function() {
        this.interaction.move(), this.interaction.end(), this.stop();
      } }, { key: "stop", value: function() {
        this.active = this.smoothEnd = false, this.interaction.simulation = null, W.cancel(this.timeout);
      } }]), t;
    }();
    function ze(t) {
    ...
    var Qn = { id: "events", install: function(t) {
            ...
            if (T.selector === l && T.context === p) {
              for (var _ = T.listeners, w = _.length - 1; w >= 0; w--) {
                ...
                if (S.func === h && Ae(S.options, y)) {
                  _.splice(w, 1), _.length || (m.splice(g, 1), s(p, f, c), s(p, f, u, true)), b = true;
                  break;
                }
              }
              if (b) break;
      ...
      }, delegateListener: c, delegateUseCapture: u, delegatedEvents: r, documents: i, targets: n, supportsOptions: false, supportsPassive: false };
      function a(l, p, f, h) {
            ...
            if (m) {
              ...
              for (var _ = he(h), w = 0; w < m.length; w++) {
                ...
                if (S.func === f && Ae(S.options, _)) {
                  l.removeEventListener(p, f, o.supportsOptions ? _ : _.capture), m.splice(w, 1), m.length === 0 && (delete g.events[p], y = true);
                  break;
                }
              }
            }
      ...
      return (e = t.document) == null || e.createElement("div").addEventListener("test", null, { get capture() {
        return o.supportsOptions = true;
      }, get passive() {
        return o.supportsPassive = true;
      } }), t.events = o, o;
    ...
    var er = { id: "core/interactions", install: function(t) {
      ...
      return D(t, [{ key: "_defaults", get: function() {
        ...
        for (var i in n) {
          ...
          o === "listeners" && this.updatePerActionListeners(e, a.listeners, s), d.array(s) ? a[o] = jt(s) : d.plainObject(s) ? (a[o] = x(a[o] || {}, re(s)), d.object(r.perAction[o]) && "enabled" in r.perAction[o] && (a[o].enabled = s.enabled !== false)) : d.bool(s) && d.object(r.perAction[o]) ? a[o].enabled = s : a[o] = s;
        }
      } }, { key: "getRect", value: function(e) {
      ...
      function t() {
        var e = this;
        k(this, t), this.id = "__interact_scope_".concat(Math.floor(100 * Math.random())), this.isInitialized = false, this.listenerMaps = [], this.browser = R, this.defaults = re(Qt), this.Eventable = sn, this.actions = { map: {}, phases: { start: true, move: true, end: true }, methodDict: {}, phaselessTypes: {} }, this.interactStatic = function(r) {
      ...
      return D(t, [{ key: "addListeners", value: function(e, n) {
        ...
        for (var r = 0, i = this.listenerMaps; r < i.length; r++) {
          var o = i[r].map[e];
          if (o && o(n, this, e) === false) return false;
        }
      } }, { key: "init", value: function(e) {
        return this.isInitialized ? this : function(n, r) {
          return n.isInitialized = true, d.window(r) && yt(r), O.init(r), R.init(r), W.init(r), n.window = r, n.document = r.document, n.usePlugin(tr), n.usePlugin(Qn), n;
        }(this, e);
    ...
    var ar = Object.freeze({ __proto__: null, edgeTarget: function() {
      ...
      if (s !== false && x(r, p), l != null && l.length) {
    ...
    }, defaults: { restriction: null, elementRect: null, offset: null, endOnly: false, enabled: false } }, dr = G(Re, "restrict"), vn = { top: 1 / 0, left: 1 / 0, bottom: -1 / 0, right: -1 / 0 }, hn = { top: -1 / 0, left: -1 / 0, bottom: 1 / 0, right: 1 / 0 };
    function gn(t, e) {
    ...
    var ge = { noInner: vn, noOuter: hn, start: function(t) {
    ...
    }, defaults: { inner: null, outer: null, offset: null, endOnly: false, enabled: false } }, vr = G(ge, "restrictEdges"), hr = x({ get elementRect() {
    ...
    }, defaults: { range: 1 / 0, targets: null, offset: null, offsetWithOrigin: true, origin: null, relativePoints: null, endOnly: false, enabled: false } }, xr = G(ft, "snap"), je = { start: function(t) {
    ...
    }, defaults: { range: 1 / 0, targets: null, offset: null, endOnly: false, enabled: false } }, wr = G(je, "snapSize"), dt = { aspectRatio: fr, restrictEdges: vr, restrict: dr, restrictRect: gr, restrictSize: br, snapEdges: G({ start: function(t) {
      var e = t.edges;
      ...
      function n(r, i, o, a, s, c) {
        ...
        } else r === "doubletap" && (u.dt = i.timeStamp - s.tapTime, u.double = true);
        return u;
      }
      ...
      vt(t), U(t, e);
    } }, PointerEvent: mn, fire: U, collectEventTargets: yn, defaults: { holdDuration: 600, ignoreFrom: null, allowFrom: null, origin: { x: 0, y: 0 } }, types: { down: true, move: true, up: true, cancel: true, tap: true, doubletap: true, hold: true } };
    function U(t, e) {
...
@esri/calcite-components/dist/chunks/interact.min.js:
  ...
  v3.1.0 *)
*/
//# sourceMappingURL=chunk-E7EGC43E.js.map
