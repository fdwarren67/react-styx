...
function m3(e3) {
  ...
  return e2((_a = y(e3)) == null ? void 0 : _a.width);
}
function y2(e3) {
...
async function O(e3) {
  const { computeObjectLayerResourceSize: t } = await import("./symbolLayerUtils-F4RIO3IX.js"), o = await t(e3, 10), { width: r, height: n2, depth: l2 } = e3, i3 = [r, l2, n2];
  let c2 = 1;
...
//# sourceMappingURL=chunk-GHPQVNNU.js.map
