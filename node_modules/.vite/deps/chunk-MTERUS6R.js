...
async function u() {
  if (!s2()) {
    const [e, t] = await Promise.all([import("./OperatorGeodesicBuffer-BULGKGWX.js"), import("./ProjectionTransformation-5RU2C5GV.js").then((e2) => e2.aG).then(({ injectPe: e2 }) => e2), _()]);
...
//# sourceMappingURL=chunk-MTERUS6R.js.map
