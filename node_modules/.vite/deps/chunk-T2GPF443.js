...
(function() {
  if (m()) {
    const e = platform.getOffsetParent;
    platform.getOffsetParent = (i) => e(i, offsetParent);
  }
})();
function U(t) {
...
var O = (
  ...
  async (t, {
    ...
    const m2 = gt(i) === "rtl", {
      ...
      strategy: k,
      middlewareData: p
    } = await computePosition2(e, i, {
      strategy: n,
      placement: a === "auto" || a === "auto-start" || a === "auto-end" ? void 0 : x(a, m2),
      middleware: J({
        placement: a,
        flipDisabled: s,
        flipPlacements: r == null ? void 0 : r.map((f) => x(f, m2)),
        offsetDistance: o,
        offsetSkidding: d,
        arrowEl: g,
        type: D
    ...
    const h = ((_a = p.hide) == null ? void 0 : _a.referenceHidden) ? "hidden" : null, $ = h ? "none" : null;
...
function J({
  ...
  return r === "menu" && o.push(
    ...
    autoPlacement2({ alignment: t === "auto-start" ? "start" : t === "auto-end" ? "end" : null })
  ) : e || o.push(flip2(i ? { fallbackPlacements: i } : {})), s && o.push(
    arrow2({
      element: s
    })
  ), o;
...
function K(t) {
  let e = u.get(t);
  return e || (e = debounce_default(O, M.reposition, {
    leading: true,
    maxWait: M.reposition
  }), u.set(t, e), e);
}
var Q = {
  top: "",
...
function Y(t) {
  ...
  if (!e || !i)
    return;
  const n = l.get(t);
  (n == null ? void 0 : n.state) === "active" && n.cleanUp(), l.delete(t), (_a = u.get(t)) == null ? void 0 : _a.cancel(), u.delete(t);
}
var E = 4;
var ut = Math.ceil(Math.hypot(E, E));
...
@esri/calcite-components/dist/chunks/floating-ui.js:
  ...
  v3.1.0 *)
*/
//# sourceMappingURL=chunk-T2GPF443.js.map
