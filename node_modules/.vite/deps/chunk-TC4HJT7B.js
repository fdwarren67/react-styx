...
async function i() {
  if (!o()) {
    const [n2, o2] = await Promise.all([import("./OperatorGeodeticArea-JAE4AMKS.js"), import("./ProjectionTransformation-5RU2C5GV.js").then((e2) => e2.aG).then(({ injectPe: e2 }) => e2), _()]);
...
async function m() {
  if (!c()) {
    const [e2] = await Promise.all([import("./apiConverter-GCJB7PQV.js"), i()]);
...
//# sourceMappingURL=chunk-TC4HJT7B.js.map
