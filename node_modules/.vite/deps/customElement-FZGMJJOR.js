...
var _s = class _s extends LitElement {
  ...
  render() {
    ...
    return html`<div aria-label=${this.label ?? this.heading ?? nothing} class=${safeClassMap({
      ...
      [`scale--${t}`]: true
    })} role=group><div class=${safeClassMap(e.heading)} role=presentation>${this.heading}</div><slot></slot></div>`;
  }
};
_s.properties = { disableSpacing: 5, heading: 1, label: 1, scale: 1 };
_s.styles = l;
var s = _s;
S("calcite-autocomplete-item-group", s);
export {
...
@esri/calcite-components/dist/components/calcite-autocomplete-item-group/customElement.js:
  ...
  v3.1.0 *)
*/
//# sourceMappingURL=customElement-FZGMJJOR.js.map
