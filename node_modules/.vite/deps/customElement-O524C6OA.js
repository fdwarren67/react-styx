...
var _z = class _z extends LitElement {
  ...
  async setFocus() {
    var _a;
    return await m3(this), (_a = this.input) == null ? void 0 : _a.setFocus();
  }
  connectedCallback() {
  ...
  willUpdate(t) {
    t.has("checked") && (this.hasUpdated || this.checked !== false) && (this.input.checked = this.checked), t.has("name") && (this.input.name = this.name);
  }
  updated() {
    m2(this);
  }
  disconnectedCallback() {
    var _a;
    super.disconnectedCallback(), (_a = this.input) == null ? void 0 : _a.remove();
  }
  // #endregion
  ...
  pointerEnterHandler() {
    ...
    (t === "calcite-radio-button" || t === "calcite-checkbox") && (this.input.hovered = true);
  }
  pointerLeaveHandler() {
    if (this.disabled)
      return;
    const { localName: t } = this.input;
    (t === "calcite-radio-button" || t === "calcite-checkbox") && (this.input.hovered = false);
  }
  // #endregion
  // #region Rendering
  renderInput() {
  ...
  render() {
    const { checked: t, description: e, disabled: c, focused: h, heading: n, icon: o, inputAlignment: s, inputEnabled: p2, width: r, iconFlipRtl: g } = this, d = n && o && !e, u = !!o;
    return p({ disabled: c, children: html`<div class=${safeClassMap({
      checked: t,
      container: true,
      [i2.description]: !!e,
      [i2.descriptionOnly]: !!(!n && !o && e),
      disabled: c,
      focused: h,
      [i2.heading]: !!n,
      [i2.headingOnly]: n && !o && !e,
      [i2.icon]: u,
      [i2.iconOnly]: !n && o && !e,
      [i2.inputAlignmentEnd]: s === "end",
      [i2.inputAlignmentStart]: s === "start",
      [i2.inputEnabled]: p2,
      [i2.largeVisual]: d,
      [i2.widthAuto]: r === "auto",
      [i2.widthFull]: r === "full"
    })}><div class=${safeClassMap({ [i2.tile]: true, [i2.tileLargeVisual]: d })}>${o && html`<div class=${safeClassMap({ [i2.icon]: u })}><calcite-icon .flipRtl=${g} .icon=${o} scale=l></calcite-icon></div>` || ""}<div class=${safeClassMap(i2.tileContentContainer)}><div class=${safeClassMap(i2.tileContent)}>${n && html`<div class=${safeClassMap(i2.tileHeading)}>${n}</div>` || ""}${e && html`<div class=${safeClassMap(i2.tileDescription)}>${e}</div>` || ""}</div></div></div><slot></slot></div>` });
  }
};
_z.properties = { focused: 16, checked: 7, description: 3, disabled: 7, heading: 3, icon: 3, iconFlipRtl: 7, inputAlignment: 3, inputEnabled: 7, name: 3, type: 3, value: 1, width: 3 };
_z.styles = B;
var z = _z;
S("calcite-tile-select", z);
export {
  z as TileSelect
};
...
@esri/calcite-components/dist/components/calcite-tile-select/customElement.js:
  ...
  v3.1.0 *)
*/
//# sourceMappingURL=customElement-O524C6OA.js.map
