...
var _b = class _b extends LitElement {
  constructor() {
    super(...arguments), this.active = false, this.appearance = "solid", this.disabled = false, this.download = false, this.dropdownIconType = "chevron", this.kind = "brand", this.loading = false, this.overlayPositioning = "absolute", this.placement = "bottom-end", this.scale = "m", this.width = "auto", this.calciteSplitButtonPrimaryClick = createEvent({ cancelable: false }), this.calciteSplitButtonSecondaryClick = createEvent({ cancelable: false });
  }
  // #endregion
  ...
  render() {
    ...
    return p({ disabled: this.disabled, children: html`<div class=${safeClassMap(i.container)}><calcite-button .appearance=${this.appearance} .disabled=${this.disabled} .download=${this.download} .href=${this.href} .iconEnd=${this.primaryIconEnd ? this.primaryIconEnd : null} .iconFlipRtl=${this.primaryIconFlipRtl ? this.primaryIconFlipRtl : null} .iconStart=${this.primaryIconStart ? this.primaryIconStart : null} .kind=${this.kind} .label=${this.primaryLabel} .loading=${this.loading} @click=${this.calciteSplitButtonPrimaryClickHandler} .rel=${this.rel} .scale=${this.scale} split-child=primary .target=${this.target} type=button .width=${a}>${this.primaryText}</calcite-button><div class=${safeClassMap(i.dividerContainer)}><div class=${safeClassMap(i.divider)}></div></div><calcite-dropdown .disabled=${this.disabled} .flipPlacements=${this.flipPlacements} @click=${this.calciteSplitButtonSecondaryClickHandler} .open=${this.active} .overlayPositioning=${this.overlayPositioning} .placement=${this.placement} .scale=${this.scale} .widthScale=${this.scale}><calcite-button .appearance=${this.appearance} .disabled=${this.disabled} .iconStart=${this.dropdownIcon} .kind=${this.kind} .label=${this.dropdownLabel} .scale=${this.scale} slot=trigger split-child=secondary type=button></calcite-button><slot></slot></calcite-dropdown></div>` });
  }
};
_b.properties = { active: 7, appearance: 3, disabled: 7, download: [3, { converter: stringOrBoolean }], dropdownIconType: 3, dropdownLabel: 3, flipPlacements: 0, href: 3, kind: 3, loading: 7, overlayPositioning: 3, rel: 3, placement: 3, primaryIconEnd: 3, primaryIconFlipRtl: 3, primaryIconStart: 3, primaryLabel: 3, primaryText: 3, scale: 3, target: 3, width: 3 };
_b.shadowRootOptions = { mode: "open", delegatesFocus: true };
_b.styles = u;
var b = _b;
S("calcite-split-button", b);
export {
  b as SplitButton
};
...
@esri/calcite-components/dist/components/calcite-split-button/customElement.js:
  ...
  v3.1.0 *)
*/
//# sourceMappingURL=customElement-RRP752UN.js.map
