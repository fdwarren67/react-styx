...
import { default as Histogram } from '@arcgis/core/widgets/Histogram.js';
...
declare const useHistogramWidget: (component: import('@arcgis/components-controllers').StencilLifecycles & {
    ...
    editConstructorProperties(props: __esri.HistogramProperties | undefined): __esri.HistogramProperties | Promise<__esri.HistogramProperties | undefined> | undefined;
} | undefined) => Histogram;
/**
 * @internal
 */
export declare class ArcgisHistogram extends LitElement {
    /**
    ...
    dataLines: nullish | __esri.HistogramDataLines[];
    /**
    ...
    label: string;
    labelFormatFunction: nullish | __esri.LabelFormatter;
