...
export class LineBuilder implements Builder {
  ...
  finishCallback: ((model: LineViewModel) => void) | undefined;

  constructor(anchorPoint: Point, graphics: Collection<Graphic>, modelRole: ModelRoles) {
    this.model = new LineViewModel(anchorPoint, modelRole);
  ...
  onFinish(finishCallback: (model: LineViewModel) => void): void {
